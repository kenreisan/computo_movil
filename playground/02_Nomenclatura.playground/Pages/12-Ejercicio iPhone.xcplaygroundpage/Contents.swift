...
*/
let iphoneTotalStorage = 8000
let iphoneUsedStorage = 3000
let iphoneFreeStorage = iphoneTotalStorage - iphoneUsedStorage
let videoMinuteStorage = 150
let videoTotalCapacity = iphoneFreeStorage / videoMinuteStorage
